...
export class ApiResult {
    ...
    // Reward
    static get REWARD_ALREADY_EXISTS() { return new ApiError("R001", "해당 리워드는 이미 존재합니다."); }
    static get REWARD_NOT_FOUND() { return new ApiError("R002", "해당 리워드는 존재하지 않습니다."); }
    ...
    static get EVENT_CONDITION_NOT_MET() { return new ApiError("E004", "해당 이벤트 조건을 충족하지 않았습니다."); }
  }
